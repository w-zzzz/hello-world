...
export const TOPICS: TopicMeta[] = [
  ...
  { slug: "02-classical-ml/05-bayesian-inference", partSlug: "02-classical-ml", partIndex: 2, topicIndex: 5, title: "Bayesian inference & priors", hook: "Likelihood × prior, conjugacy, MCMC — and the bridge to modern Bayesian deep learning.", estMinutes: 18, difficulty: 3, prereqs: ["01-math/02-probability-information"], hasHeroViz: false, researchers: ["mackay", "koller"] },
  { slug: "02-classical-ml/06-gaussian-processes", partSlug: "02-classical-ml", partIndex: 2, topicIndex: 6, title: "Gaussian processes", hook: "Non-parametric regression with calibrated uncertainty — and the kernel that became the NTK.", estMinutes: 16, difficulty: 4, prereqs: ["02-classical-ml/05-bayesian-inference", "02-classical-ml/02-svm"], hasHeroViz: false, researchers: ["mackay"] },
  { slug: "02-classical-ml/07-em-hmm", partSlug: "02-classical-ml", partIndex: 2, topicIndex: 7, title: "EM algorithm & HMMs", hook: "Hidden variables, Baum-Welch, and why HMMs ruled speech for thirty years.", estMinutes: 16, difficulty: 3, prereqs: ["02-classical-ml/05-bayesian-inference"], hasHeroViz: false, researchers: ["koller"] },
  { slug: "02-classical-ml/08-information-bottleneck", partSlug: "02-classical-ml", partIndex: 2, topicIndex: 8, title: "Information bottleneck", hook: "Tishby's lens on representation learning — controversy, revival, and what it really tells us.", estMinutes: 14, difficulty: 4, prereqs: ["01-math/02-probability-information"], hasHeroViz: false, researchers: ["mackay"] },
  ...
  { slug: "05-reasoning-agents/05-agentic-coding", partSlug: "05-reasoning-agents", partIndex: 5, topicIndex: 5, title: "Agentic coding: Cursor, Claude Code, Cognition", hook: "IDE-resident vs autonomous coding agents — tool-use patterns and benchmarks.", estMinutes: 16, difficulty: 3, prereqs: ["05-reasoning-agents/03-mcp-agent-frameworks"], hasHeroViz: false, researchers: ["amodei", "karpathy"] },
  { slug: "05-reasoning-agents/06-computer-use-agents", partSlug: "05-reasoning-agents", partIndex: 5, topicIndex: 6, title: "Computer-use agents", hook: "Anthropic Computer Use, OpenAI Operator, Project Mariner — pixel-grounded vs DOM-grounded.", estMinutes: 14, difficulty: 3, prereqs: ["05-reasoning-agents/02-cot-react", "06-multimodal/02-llava"], hasHeroViz: false, researchers: ["amodei"] },
  ...
  { slug: "06-multimodal/06-vla-and-robotics", partSlug: "06-multimodal", partIndex: 6, topicIndex: 6, title: "Vision-language-action models", hook: "RT-2, OpenVLA, π_0 — from internet-pretrained to embodied.", estMinutes: 16, difficulty: 4, prereqs: ["06-multimodal/02-llava"], hasHeroViz: false, researchers: ["finn", "levine", "fan-jim"] },
  { slug: "06-multimodal/07-ai-for-science", partSlug: "06-multimodal", partIndex: 6, topicIndex: 7, title: "AI for science", hook: "AlphaFold, Boltz-1, GraphCast, AlphaProof — when models do new science.", estMinutes: 16, difficulty: 3, prereqs: ["03-deep-learning/04-attention"], hasHeroViz: false, researchers: ["hassabis", "anandkumar", "koller"] },
  ...
  { slug: "10-cutting-edge/09-rsps-and-safety", partSlug: "10-cutting-edge", partIndex: 10, topicIndex: 9, title: "Responsible scaling policies & safety", hook: "RSPs, Preparedness, the EU AI Act, METR — how the field tries to govern itself.", estMinutes: 16, difficulty: 3, prereqs: ["04-transformers-llms/04-instruction-tuning"], hasHeroViz: false, researchers: ["amodei", "madry", "bommasani", "russell", "leike"] },
  { slug: "10-cutting-edge/10-frontier-models-2025", partSlug: "10-cutting-edge", partIndex: 10, topicIndex: 10, title: "Frontier model landscape 2025-26", hook: "Claude 4, GPT-5, Gemini 2.5, DeepSeek-V3.1/R1.5, Llama 4, Qwen 3 — strengths, costs, openness.", estMinutes: 18, difficulty: 3, prereqs: ["04-transformers-llms/03-scaling-laws"], hasHeroViz: false, researchers: ["amodei", "brockman", "hassabis", "wenfeng", "murati"] },
  { slug: "10-cutting-edge/11-history-perceptron", partSlug: "10-cutting-edge", partIndex: 10, topicIndex: 11, title: "Perceptron and the first AI winter", hook: "Rosenblatt 1958, Minsky-Papert 1969, Lighthill 1973 — the first crash.", estMinutes: 14, difficulty: 2, prereqs: [], hasHeroViz: false, researchers: ["hinton"] },
  { slug: "10-cutting-edge/12-history-expert-systems", partSlug: "10-cutting-edge", partIndex: 10, topicIndex: 12, title: "Expert systems & the second AI winter", hook: "MYCIN, DENDRAL, Cyc — why hand-coded knowledge hit a wall.", estMinutes: 14, difficulty: 2, prereqs: [], hasHeroViz: false, researchers: ["russell"] },
  { slug: "10-cutting-edge/13-history-imagenet-moment", partSlug: "10-cutting-edge", partIndex: 10, topicIndex: 13, title: "The ImageNet moment", hook: "Fei-Fei Li, AlexNet 2012, ResNet — why one benchmark restarted the field.", estMinutes: 14, difficulty: 2, prereqs: ["03-deep-learning/02-cnn"], hasHeroViz: false, researchers: ["fei-fei", "sutskever", "hinton", "he"] },
  { slug: "10-cutting-edge/14-history-rl-atari-to-go", partSlug: "10-cutting-edge", partIndex: 10, topicIndex: 14, title: "From Atari to Go: deep RL's coming-of-age", hook: "DQN 2013, AlphaGo 2016, AlphaZero, MuZero.", estMinutes: 16, difficulty: 3, prereqs: ["08-rl/02-q-learning"], hasHeroViz: false, researchers: ["silver", "hassabis", "sutton"] },
  ...
  { slug: "11-niche-pivotal/08-diffusion-policy", partSlug: "11-niche-pivotal", partIndex: 11, topicIndex: 8, title: "Diffusion policies for control", hook: "Diffusion as a flexible distribution over action sequences — Chi 2023, π_0, RDT-1B.", estMinutes: 16, difficulty: 4, prereqs: ["06-multimodal/03-diffusion-ddpm-sd", "08-rl/03-policy-gradient-ppo"], hasHeroViz: false, researchers: ["chi-cheng", "levine", "finn"] },
];
