...
// Stubs for M2/M5/M6 deferred interactive components.
export const IndicatorPlayground = (props: Record<string, unknown>) => (
  <div className="my-4 rounded-lg border border-dashed p-4 text-sm text-muted-foreground">
    Indicator playground — available in M2 (props: {Object.keys(props).join(', ') || 'none'}).
  </div>
)
